<template>
  ...
  <div v-else>
    ...
    <div class="main-logo-wrapper">
      <img
        :class="layoutCssName + ' layout main-logo'"
        :data-scroll="scrollY"
        alt="RPI TV logo"
        src="@/assets/rpitv_logo.svg"
      />
    </div>
...
// When the user switches routes, we set a flag so that router-based modals know whether to be displayed inline or
//  whether they should pop up as a modal.
const stopWatch = watch(
  () => route.name,
  (value, oldValue) => {
    if (oldValue !== undefined) {
      routeStore.hasSwitchedRoutes = true;
      stopWatch();
    }
  }
);
